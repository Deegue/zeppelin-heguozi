...
function HomeCtrl($scope, noteListFactory, websocketMsgSrv, $rootScope, arrayOrderingSrv,
  ...
  $scope.initHome = function() {
    ...
    if(!window.location.href.contains('code=')) {
      window.location.href = 'https://o2.2dfire.net/o2/oauth/authorize?client_id=de79d64f3ac21301&' +
        'response_type=code&redirect_uri=http://zp.2dfire.net/&scope=read write openid&state=123';
      return;
    }
    // alert('start login+');
    $rootScope.login();
